        ...
        <div className="p-6 md:p-10">
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                ...
                <div className="bg-black/40 border border-white/10 p-3 relative group hover:border-grim-pink/50 transition-colors">
                  <div className="text-3xl font-display font-bold text-white group-hover:text-grim-pink transition-colors">{likesCount}</div>
          ...
          <div className="flex flex-wrap gap-4 pt-6 border-t border-white/10">
            <button
              ...
              className="group flex-grow min-w-[200px] relative px-8 py-4 bg-grim-cyan hover:bg-white text-black font-black uppercase tracking-widest text-sm transition-all overflow-hidden clip-path-polygon-[10px_0,100%_0,100%_calc(100%-20px),calc(100%-20px)_100%,0_100%,0_10px]"
