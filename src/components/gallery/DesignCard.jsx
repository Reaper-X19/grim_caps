  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-black overflow-hidden border-b border-white/5">
        ...
        {/* Featured Badge */}
        {design.is_featured && (
          <div className="absolute top-0 left-0 px-3 py-1 bg-grim-cyan text-black text-[10px] font-black uppercase tracking-widest clip-path-polygon-[0_0,100%_0,calc(100%-10px)_100%,0_100%]"
