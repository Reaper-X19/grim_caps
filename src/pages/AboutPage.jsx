      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index}
                  className={`group relative bg-grim-panel p-8 border border-white/5 transition-all duration-300 hover:-translate-y-2 ${item.border}`}
          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative aspect-video bg-black border border-grim-cyan/30 p-2">
                ...
                <div className="w-full h-full bg-grim-void flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 font-mono text-[10px] text-grim-cyan uppercase">
                    STATUS: ONLINE<br />
                    SYS_UPTIME: 99.9%
                  </div>
                </div>
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="font-mono text-sm text-gray-400 space-y-4 border-l border-white/10 pl-6 relative">
                ...
                <p>
                  <span className="text-grim-purple opacity-70 font-bold uppercase tracking-widest text-[10px]">THE PROBLEM:</span> <br />
                ...
                <p>
                  <span className="text-grim-purple opacity-70 font-bold uppercase tracking-widest text-[10px]">THE SOLUTION:</span> <br />
                ...
                <p>
                  <span className="text-grim-purple opacity-70 font-bold uppercase tracking-widest text-[10px]">THE RESULT:</span> <br />
        ...
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-gray-400 font-mono text-sm max-w-xl mx-auto mb-10 uppercase tracking-wide">
